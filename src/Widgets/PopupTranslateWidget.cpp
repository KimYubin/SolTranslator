...
void PopupTranslateWidget::setupUI()
{
    ...
    _AlwaysOnButton->setCheckToolTipShortcut(tr("항상 위 끄기"), tr("항상 위 켜기"), solConfig.shortcut(Action::PopupAlwaysOn));
    ...
    _windowModeButton->setCheckToolTipShortcut(tr("임시창 모드"), tr("일반창 모드"), solConfig.shortcut(Action::PopupWindowMode));
    ...
    _minimizedButton->setToolTipShortcut(tr("최소화"), solConfig.shortcut(Action::PopupMinimize));
    ...
    _maxRestoreButton->setCheckToolTipShortcut(tr("이전 크기로 복원"), tr("최대화"), solConfig.shortcut(Action::PopupMaxRestore));
    ...
    _closeButton->setToolTipShortcut(tr("닫기"), solConfig.shortcut(Action::PopupClose));
    ...
    _textToggleButton->setToolTipShortcut(tr("원문/번역 토글"), solConfig.shortcut(Action::PopupToggle));
