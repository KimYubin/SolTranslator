...
static_assert(int(SolMarkdownImporter::FeatureCollapseWhitespace) == MD_FLAG_COLLAPSEWHITESPACE);
static_assert(int(SolMarkdownImporter::FeaturePermissiveATXHeaders) == MD_FLAG_PERMISSIVEATXHEADERS);
static_assert(int(SolMarkdownImporter::FeaturePermissiveURLAutoLinks) == MD_FLAG_PERMISSIVEURLAUTOLINKS);
static_assert(int(SolMarkdownImporter::FeaturePermissiveMailAutoLinks) == MD_FLAG_PERMISSIVEEMAILAUTOLINKS);
static_assert(int(SolMarkdownImporter::FeatureNoIndentedCodeBlocks) == MD_FLAG_NOINDENTEDCODEBLOCKS);
static_assert(int(SolMarkdownImporter::FeatureNoHTMLBlocks) == MD_FLAG_NOHTMLBLOCKS);
static_assert(int(SolMarkdownImporter::FeatureNoHTMLSpans) == MD_FLAG_NOHTMLSPANS);
static_assert(int(SolMarkdownImporter::FeatureTables) == MD_FLAG_TABLES);
static_assert(int(SolMarkdownImporter::FeatureStrikeThrough) == MD_FLAG_STRIKETHROUGH);
static_assert(int(SolMarkdownImporter::FeatureUnderline) == MD_FLAG_UNDERLINE);
static_assert(int(SolMarkdownImporter::FeaturePermissiveWWWAutoLinks) == MD_FLAG_PERMISSIVEWWWAUTOLINKS);
static_assert(int(SolMarkdownImporter::FeaturePermissiveAutoLinks) == MD_FLAG_PERMISSIVEAUTOLINKS);
static_assert(int(SolMarkdownImporter::FeatureTasklists) == MD_FLAG_TASKLISTS);
static_assert(int(SolMarkdownImporter::FeatureNoHTML) == MD_FLAG_NOHTML);
static_assert(int(SolMarkdownImporter::DialectCommonMark) == MD_DIALECT_COMMONMARK);
static_assert(int(SolMarkdownImporter::DialectGitHub) ==
    (MD_DIALECT_GITHUB | MD_FLAG_UNDERLINE | SolMarkdownImporter::FeatureFrontMatter));
...
{
    SolMarkdownImporter* mdi = static_cast<SolMarkdownImporter*>(userdata);
...
SolMarkdownImporter::SolMarkdownImporter(QTextDocument* doc, SolMarkdownImporter::Features features)
    : m_cursor(doc)
...
SolMarkdownImporter::SolMarkdownImporter(QTextDocument* doc, QTextDocument::MarkdownFeatures features)
    : SolMarkdownImporter(doc, static_cast<SolMarkdownImporter::Features>(int(features)))
{
}
...
void SolMarkdownImporter::import(const QString& markdown)
{
    ...
    if (m_features.testFlag(SolMarkdownImporter::FeatureFrontMatter))
    {
...
int SolMarkdownImporter::cbEnterBlock(int blockType, void* det)
{
...
int SolMarkdownImporter::cbLeaveBlock(int blockType, void* detail)
{
    Q_UNUSED(detail);
    switch (blockType)
    {
...
int SolMarkdownImporter::cbEnterSpan(int spanType, void* det)
{
    QTextCharFormat charFmt;
...
int SolMarkdownImporter::cbLeaveSpan(int spanType, void* detail)
{
    Q_UNUSED(detail);
    QTextCharFormat charFmt;
    if (!m_spanFormatStack.isEmpty())
...
int SolMarkdownImporter::cbText(int textType, const char* text, unsigned size)
{
...
*/
void SolMarkdownImporter::insertBlock()
{
